<dl id="Bottom">
    ...
    @else
        <dd><a href="immediate.html"><img src="{{$cdn}}/phone/img/tab_0_normal.png"><p>足球</p></a></dd>
    @endif
    @if($index == 1)
        <dd class="on"><a><img src="{{$cdn}}/phone/img/tab_2_seleted.png"><p>篮球</p></a></dd>
    @else
        <dd><a href="immediate_bk.html"><img src="{{$cdn}}/phone/img/tab_2_normal.png"><p>篮球</p></a></dd>
    @endif
    @if($index == 2)
