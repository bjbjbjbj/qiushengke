<?php $liveUrl = \App\Http\Controllers\PC\CommonTool::matchWapLivePathWithId($match['mid'],2); ?>
<div id="Navigation">
    <div class="banner">
...
<div id="Info">
    ...
    <div class="info">
        ...
        @if($match['status'] > 0 && $match['live'] > 0)<a href="{{$liveUrl}}" class="live" style="display: none">正在直播</a>@endif
    </div>
    <div class="team">
