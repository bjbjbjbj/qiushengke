...
@section('css')
    <link rel="stylesheet" href="/css/tree/zTreeStyle/zTreeStyle.css" type="text/css">
@endsection
@section('content')
...
@endsection
@section('js')
    <script type="text/javascript" src="/js/tree/ztree/jquery.ztree.core.min.js"></script>
    <script type="text/javascript" src="/js/tree/ztree/jquery.ztree.excheck.min.js"></script>
