        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped" style="border-top: 1px solid #ccc">
                ...
                <tr>
                    ...
                    <th>访问路径</th>
                    <th style="width: 120px;">父权限</th>
                    <th style="width: 90px;">目录</th>
                ...
                @foreach($resources as $resource)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info" onclick="editRes('{{$resource->id}}');">
                                <span class="glyphicon glyphicon-ok"></span>保存
                            </a>
                            <a class="btn btn-sm btn-danger" onclick="delRes('{{ $resource->id }}');">
