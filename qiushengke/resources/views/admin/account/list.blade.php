    ...
    <div class="row placeholders">
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                <tr>
                    <form id="new_form" action="/admin/accounts/save" method="post" onsubmit="return setRoles('new_form');">
                        <th>
                            {{ csrf_field() }}
                ...
                @foreach($page as $account)
                    <form id="edit_{{$account->id}}" action="/cms/account/update/" method="post" onsubmit="return setRoles('edit_{{$account->id}}');">
                        {{ csrf_field() }}
