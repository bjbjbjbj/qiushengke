...
<div class="con {{$className}}" ma="{{$ma}}" ha="{{$ha}}" @if($show == 0) style="display: none;" @endif>
    @component('pc.match_detail.basket_cell.data_history_item_head',['key'=>10,'hWinCount'=>$h10WinCount,'aWinCount'=>$a10WinCount])
    @endcomponent
    @component('pc.match_detail.basket_cell.data_history_item_head',['key'=>5,'hWinCount'=>$h5WinCount,'aWinCount'=>$a5WinCount,'show'=>0])
    @endcomponent
