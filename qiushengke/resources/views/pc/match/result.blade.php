        ...
        <div id="Calendar">
            <ul>
                @foreach($calendar as $item)
                    <a class="li {{$item['on'] ? 'on':''}}" href="{{'/match/foot/'.$item['date'].'/result.html'}}">
...
@section('match_list_date')
    <div class="abox">
        <ul>
            ...
            <a class="li on" href="/match/foot/{{$lastDate}}/result.html">完场赛果</a>
            <a class="li" href="/match/foot/{{$nextDate}}/schedule.html">未来赛程</a>
        </ul>
    </div>
@endsection
...
@section('js_match_list')
    ...
    <script type="text/javascript">
        ...
        function clickDate(date) {
            ...
            var url = '{{env('APP_URL')}}' + '/match/foot/'+value+'/result.html';
